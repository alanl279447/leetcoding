...
public class ZombieMatrix_Amazon {
    ...
    //add all the 1's to the queue.
    //for the size of queue, navigate all 4 directions, increment res once for all eleements in the size
